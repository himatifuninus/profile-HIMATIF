      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 z-0 bg-[#080412] overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(99,60,180,0.2) 0%, transparent 70%)",
              filter: "blur(80px)",
            }}
                ...
                >
                  ...
                  <Link to="/about">
                    <motion.button
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, rgba(139,92,246,0.9) 0%, rgba(217,70,239,0.9) 50%, rgba(14,116,144,0.8) 100%)",
                        boxShadow:
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              HIMATIF hadir sebagai wadah pengembangan akademik, organisasi, dan
              kebersamaan mahasiswa Teknik Informatika
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                src: "Himatif25.jpg",
                alt: "HIMATIF 2025",
                label: "HIMATIF 2025 - 2026",
              },
              {
                to: "/angkatan-2425",
                src: "Himatif24.jpeg",
                alt: "HIMATIF 2024",
                label: "HIMATIF 2024 - 2025",
              },
              {
                to: "/angkatan-2324",
                src: "himatif23.jpeg",
                alt: "HIMATIF 2023",
                label: "HIMATIF 2023 - 2024",
              },
              {
                to: "/angkatan-2223",
                src: "Himatif22.jpg",
                alt: "HIMATIF 2022",
                label: "HIMATIF 2022 - 2023",
              },
            ].map((item) => (
